...
// Brand glyphs: Simple Icons, CC0; see ../assets/provider-icons/NOTICE.md.
export type LibraryProvider = 'modrinth' | 'curseforge'
const paths: Record<LibraryProvider, string> = {
...
export function ProviderIcon({
  ...
  return <svg aria-hidden="true" focusable="false" viewBox="0 0 24 24" width={size} height={size}
    className={`shrink-0 ${className}`.trim()} style={{ color: provider === 'modrinth' ? '#00af5c' : '#f16436' }} fill="currentColor">
