...
| `NamLauncher/website` | Public | Static public website source and browser-level regression tests |
| `NamLauncher/platform` | Private | API, Admin, Discord integration, authentication, release metadata, and data schemas |
| `NamLauncher/minecraft-companions` | Public | Fabric, Forge, and NeoForge source, compatibility tests, and bundle exporter |
...
Companion source and build toolchains remain in their dedicated public
repository instead of being duplicated in the launcher repository. Operations
contains no application source or production secret.
